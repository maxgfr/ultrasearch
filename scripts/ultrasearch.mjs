...
2. **Gather per sub-question** \u2014 for EVERY entry in \`${join11(runAbs, "PLAN.json")}\`, apply \`${join11(runAbs, "orchestration", "agents", "gatherer.md")}\` yourself: run its \`gather --q \u2026 --queries \u2026 --out <its out dir>\`, then enrich a thin or under-covered sub-dossier (your WebSearch + \`fetch --url \u2026 --out <its out dir>\`).
