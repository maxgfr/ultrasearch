...
export const SKILL_NAME = "ultrasearch";
...
// them:
//
//   <payload>/scripts/ultrasearch.mjs  → <payload>/SKILL.md              (installed skill)
//   <repo>/scripts/ultrasearch.mjs     → <repo>/skills/ultrasearch/SKILL.md (repo-root bundle)
//   <repo>/src/mcp/resources.ts     → <repo>/skills/ultrasearch/SKILL.md (source tree, tests)
//
